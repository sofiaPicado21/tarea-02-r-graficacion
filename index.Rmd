...
```{r}
library(ggplot2)
ggplot(ca_covid19, aes(x=reorder(pais, -positivos), y=positivos, fill=reorder(pais, -positivos))) +
  ggtitle("Casos positivos de COVID-19 en Centroamérica y República Dominicana") +
  xlab("País") +
...
ggplot(ca_covid19, aes(x=reorder(pais, -fallecidos), y=fallecidos)) +
  ggtitle("Cantidad fallecidos por COVID-19 en Centroamérica y República Dominicana") +
  xlab("País") + 
...
```{r}
ggplot(ca_covid19, aes(x=reorder(pais, -activos), y=activos, fill=reorder(pais, -activos))) +
  ggtitle("Cantidad de casos activos de COVID-19 en Centroamérica y República Dominicana") +
  xlab("País") + 
  ylab("Casos activos") +  
  geom_col() +
...
```{r}
ggplot(ca_covid19, aes(x=reorder(pais, -recuperados), y=recuperados, fill=reorder(pais, -recuperados))) +
  ggtitle("Cantidad de personas recuperadas de COVID-19 en Centroamérica y República Dominicana") +
  xlab("País") + 
...
```{r}
ggplot(ca_covid19, aes(x=pais, y=positivos, fill=recuperados)) +
